"""AI Task integration for OmniConv."""
...
async def async_setup_entry(
    ...
    for subentry in config_entry.subentries.values():
        ...
        async_add_entities(
            [OmniConvTaskEntity(config_entry, subentry)],
            config_subentry_id=subentry.subentry_id,
        )


class OmniConvTaskEntity(
    ai_task.AITaskEntity,
    OmniConvBaseLLMEntity,
):
    """OmniConv AI Task entity."""
    ...
    async def _async_generate_image(
        ...
        await self._async_handle_chat_log(chat_log, structure_name=task.name, force_image=True)
        ...
        return ai_task.GenImageTaskResult(
            ...
            revised_prompt=image_call.revised_prompt if hasattr(image_call, "revised_prompt") else None,
        )
